...
#create object
#base
bpy.ops.mesh.primitive_cube_add(location=(base_height/2.0, 0.0, thickness/2.0), scale=(base_height, width, thickness))
...
bevel(base, "topleft", base_radius)
bevel(base, "topright", base_radius)
